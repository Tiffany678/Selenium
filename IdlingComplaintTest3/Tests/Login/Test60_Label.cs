...
namespace IdlingComplaints.Tests.Login
{
    ...
    internal class Test60_Label : LoginModel
    {
        ...
        public void VerifyForgotPasswordLink()
        {
            ...
            Assert.That(forgotPassLink, Is.EqualTo("https://sampleUrl/password-reset"), "Forgot Password Link is not routing to \"/password-reset\" link.");
        }
        ...
        public void VerifyCreateAccountLink()
        {
            ...
            Assert.That(createAccountLink, Is.EqualTo("https://sampleUrl/profile"), "Forgot Password Link is not routing to \"/profile\" link.");
        }
    }
}
